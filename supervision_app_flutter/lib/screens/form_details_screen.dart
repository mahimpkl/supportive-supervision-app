      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildStaffTrainingRow('HA', staffTraining.haTotalStaff ?? 0, staffTraining.haKhdcTrained ?? 0, staffTraining.haFenTrained ?? 0, staffTraining.haOtherNcdTrained ?? 0),
            _buildStaffTrainingRow('Sr. AHW', staffTraining.srAhwTotalStaff ?? 0, staffTraining.srAhwKhdcTrained ?? 0, staffTraining.srAhwFenTrained ?? 0, staffTraining.srAhwOtherNcdTrained ?? 0),
            _buildStaffTrainingRow('AHW', staffTraining.ahwTotalStaff ?? 0, staffTraining.ahwKhdcTrained ?? 0, staffTraining.ahwFenTrained ?? 0, staffTraining.ahwOtherNcdTrained ?? 0),
          ],
        ),
      ),
    );
